...
class AnimeServiceTest {
    ...
    void findAll_ReturnsPaginatedAnimes_WhenSuccessful() {
        var pageRequest = PageRequest.of(0, this.animeList.size());
        var pagedAnimes = new PageImpl<>(this.animeList, pageRequest, 1);
        ...
        Assertions.assertThat(animesFound.getContent()).hasSameElementsAs(this.animeList);
    }
