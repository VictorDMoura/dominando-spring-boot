...
public class CustomerController {
    ...
    private static final List<String> NAMES = List.of("William", "Brenon", "Wildnei", "Fabricio");
    ...
    //http://localhost:8080/v1/customers/{customerId}/payments/{paymentId} << PathVariable
    @GetMapping("{name}")
