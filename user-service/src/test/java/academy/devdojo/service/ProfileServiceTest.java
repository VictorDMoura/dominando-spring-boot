...
class ProfileServiceTest {
    ...
    @InjectMocks
    private ProfileUtils userUtils;
    @Mock
    ...
    @BeforeEach
    void init() {
        profiles = userUtils.newProfileList();
    }
    ...
    void findAll_ReturnsAllProfiles_WhenSuccessful() {
        ...
        assertThat(users).hasSameElementsAs(this.profiles);
    }
    ...
    void save_CreatesProfile_WhenSuccessful() {
        var profileToSave = userUtils.newProfileToSave();
        var profileSaved = userUtils.newProfileSaved();
